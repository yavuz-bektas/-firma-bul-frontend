<template>
  <div v-if="$store.state.companiesListDetailsModal">
    <div
    ...
    >
      ...
      <div
        ...
        role="document"
      >
        <div v-if="badgestatus">
          <!-- Badge (green) -->
          <div
            class="font-semibold inline-flex px-2 py-1 leading-4 text-sm rounded text-green-700 bg-green-200"
          >
            Başarıyla eklendi!
          </div>
        </div>
        ...
        <div class="p-5 lg:p-6 flex-grow w-full">
          <p class="text-gray-600 mb-5">
            Fabrikanız ile alakalı detayları ekleyiniz
          </p>
          ...
          <div class="space-y-1">
            ...
            <div class="relative">
              ...
              <input
                v-model="factoryenddate"
                class="block border border-gray-200 rounded pl-20 pr-5 py-3 leading-6 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                type="text"
                id="tk-form-input-groups-prepend-large--iconaddon"
                placeholder="2021-12-24"
              />
            </div>
          </div>
          ...
          <div class="space-y-1">
            ...
            <div class="relative">
              ...
              <input
                v-model="factorydiscountedprice"
                class="block border border-gray-200 rounded pl-20 pr-5 py-3 leading-6 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                type="text"
                id="tk-form-input-groups-prepend-large--iconaddon"
                placeholder="165"
...
export default {
  data() {
    return {
      ...
      factoryusingkw: "",
      factoryusingsalary: "",
      factorydiscountedprice: "",
      badgestatus: false,
    };
  },
  methods: {
    closeBar() {
      this.$store.commit("setcompaniesListDetailsModal", false);
    },

    async submitNewData() {
      await axios
        .post("http://localhost:3060/addfactoryattr", {
          factoryname: this.factoryname,
          fromdate: this.factorydate,
          todate: this.factoryenddate,
          usingkw: this.factoryusingkw,
          usingsalary: this.factoryusingsalary,
          discountedprice: this.factorydiscountedprice,
        })
        .then((res) => {
          if (res.status === 201) {
            ...
            this.factorydate = "";
            this.factoryenddate = "";
            this.factorryusingkw = "";
            this.factoryusingsalary = "";
            this.factorydiscountedprice = "";
            this.$store.dispatch(
