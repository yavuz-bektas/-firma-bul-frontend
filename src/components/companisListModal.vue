<template>
  <div v-if="$store.state.compapnisListModadl">
    <div
      ...
      >
        ...
        <div class="p-5 lg:p-6 flex-grow w-full">
          <p class="text-gray-600 mb-5">
            Uygulamanıza bir fabrikayı veya işinizi davet edin ve mevcut
            projenize ekleyin.
          </p>
...
export default {
  ...
  methods: {
    closeBar() {
      this.$store.commit("setcompaniesListModal", false);
    },

    async submitNewData() {
      await axios
        .post("http://localhost:3060/addfactory", {
          factoryname: this.factoryname,
          factorydate: this.factorydate,
          factoryenddate: this.factoryenddate,
          factoryworker: this.factoryworker,
