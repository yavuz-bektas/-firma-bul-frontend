  ...
  >
    ...
    <main id="page-content" class="flex flex-auto flex-col max-w-full">
      <div
        ...
        style="
          background-image: url('https://source.unsplash.com/9XngoIpxcEo/1920x1200');
        "
      >
        <!-- Sign Up Section -->
        <div
          class="flex flex-grow md:w-8/12 lg:w-5/12 xl:w-4/12 bg-white shadow-xl"
        >
              ...
              <div class="w-full max-w-lg mx-auto space-y-10">
                ...
                <div>
                  ...
                  >
                    <svg
                      ...
                      class="text-indigo-500 hi-solid hi-cube-transparent inline-block w-8 h-8"
                    >
                      <path
                        fill-rule="evenodd"
                  ...
                  <p class="text-gray-500">Yeni Kullanıcı Kaydı</p>
                </div>
                <!-- END Header -->
                ...
                <div class="text-sm text-gray-500">
                  <router-link
                    ...
                    to="/"
                    >Giriş Sayfasına Dön</router-link
                  >
                  <br><br><br>
                  <dangerAlerts />
                </div>
...
<script>
import dangerAlerts from "../components/dangerAlerts.vue";
